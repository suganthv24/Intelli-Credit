...
Generated by Intelli-Credit AI Platform | {_TODAY}""".strip()
...
def _header(fig):
    ...
    _hax.text(0.5, 0.62, "Intelli-Credit AI Platform",
...
def _footer(fig, page, total):
    fig.text(0.5, 0.004,
             f"Page {page} of {total}   |   Intelli-Credit AI Platform   |   {_TODAY}",
...
ax3.text(0.5, _y3 - 0.04,
         f"Auto-generated by Intelli-Credit AI Platform on {_TODAY}. "
